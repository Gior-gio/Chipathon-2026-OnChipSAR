...
N -660 -130 -600 -130 {lab=Vcomp}
N -220 -130 -160 -130 {lab=VCB}
N -300 -240 -300 -200 {lab=VDD}
N -300 -60 -300 -30 {lab=VSS}
N -440 -130 -380 -130 {lab=VCN}
...
C {iopin.sym} -660 -130 0 1 {name=p19 lab=Vcomp}
...
C {designs/sar_adc/digital/inverter/xschem/inverter.sym} -500 -110 0 0 {name=x2}
C {lab_pin.sym} -520 -220 0 1 {name=p29 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -520 -40 0 1 {name=p30 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -160 -130 2 0 {name=p31 sig_type=std_logic lab=VCB}
C {designs/sar_adc/digital/inverter/xschem/inverter.sym} -280 -110 0 0 {name=xINVB[2:0]}
C {lab_pin.sym} -300 -220 0 1 {name=p32 sig_type=std_logic lab=VDD}
C {lab_pin.sym} -300 -40 0 1 {name=p33 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -410 -130 1 0 {name=p34 sig_type=std_logic lab=VCN}
...
C {lab_pin.sym} 440 -550 1 1 {name=p55 sig_type=std_logic lab=CKN10}
