...
N 120 -160 140 -160 {lab=VSS}
N 290 -200 310 -200 {lab=CLK}
N 290 -160 310 -160 {lab=CLKN}
N 400 -200 420 -200 {lab=A}
N 400 -160 420 -160 {lab=B}
...
C {lab_pin.sym} 310 -160 0 1 {name=p13 sig_type=std_logic lab=CLKN
}
C {lab_pin.sym} 120 -160 0 0 {name=p14 sig_type=std_logic lab=VSS
}
C {lab_pin.sym} 120 -200 2 1 {name=p15 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 310 -200 0 1 {name=p16 sig_type=std_logic lab=CLK}
C {lab_pin.sym} 400 -200 0 0 {name=p17 sig_type=std_logic lab=A}
C {lab_pin.sym} 400 -160 0 0 {name=p18 sig_type=std_logic lab=B
}
