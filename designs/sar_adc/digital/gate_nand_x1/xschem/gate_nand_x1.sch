...
C {iopin.sym} -340 -230 0 0 {name=p3 lab=A
}
...
C {symbols/nfet_03v3.sym} -90 50 0 0 {name=M6
L=0.28u
W=0.5u
nf=1
m=1
...
C {symbols/pfet_03v3.sym} 60 -130 0 1 {name=M7
L=0.28u
W=0.5u
nf=1
m=2
...
C {symbols/nfet_03v3.sym} -90 140 0 0 {name=M8
L=0.28u
W=0.5u
nf=1
m=1
...
C {lab_pin.sym} 40 -180 1 0 {name=p23 sig_type=std_logic lab=VDD}
C {iopin.sym} -70 200 2 0 {name=p24 lab=VSS}
C {lab_pin.sym} -160 50 0 0 {name=p25 sig_type=std_logic lab=A}
C {lab_pin.sym} -240 -130 0 0 {name=p27 sig_type=std_logic lab=A}
C {lab_pin.sym} 100 -130 2 0 {name=p28 sig_type=std_logic lab=B}
C {lab_pin.sym} -40 50 2 0 {name=p29 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -140 140 0 0 {name=p1 sig_type=std_logic lab=B}
