...
N 650 70 650 110 {lab=VDD}
N 580 -20 640 -20 {lab=nand1}
...
N 800 -20 880 -20 {lab=#net1}
N 980 60 980 100 {lab=VSS}
N 980 -140 980 -100 {lab=VDD}
N 1080 -20 1200 -20 {lab=#net2}
...
N 840 -20 840 270 {lab=#net1}
N 840 270 980 270 {lab=#net1}
N 1300 40 1300 80 {lab=VSS}
N 1300 -160 1300 -120 {lab=VDD}
N -140 -0 -80 0 {lab=D}
N 650 110 650 120 {lab=VDD}
N 510 120 510 130 {lab=VSS}
N 880 -20 900 -20 {lab=#net1}
N 980 50 980 60 {lab=VSS}
N 1060 -20 1080 -20 {lab=#net2}
...
N 410 270 580 270 {lab=#net3}
N 120 270 250 270 {lab=tg1}
N 980 270 1060 270 {lab=#net1}
N 1220 270 1470 270 {lab=Q}
N 580 -20 580 40 {lab=nand1}
N 420 -20 580 -20 {lab=nand1}
N 580 200 580 270 {lab=#net3}
...
C {lab_pin.sym} 650 70 3 1 {name=p20 sig_type=std_logic lab=VDD}
...
C {lab_pin.sym} 510 170 1 1 {name=p28 sig_type=std_logic lab=VSS}
...
C {lab_pin.sym} 720 -120 3 1 {name=p38 sig_type=std_logic lab=CLK2N
}
C {lab_pin.sym} 330 170 1 0 {name=p39 sig_type=std_logic lab=CLK2N
}
C {lab_pin.sym} 1140 170 1 0 {name=p40 sig_type=std_logic lab=CLK
}
C {lab_pin.sym} 0 80 3 0 {name=p41 sig_type=std_logic lab=CLKN

}
C {lab_pin.sym} 330 350 1 1 {name=p42 sig_type=std_logic lab=CLK2
}
C {lab_pin.sym} 1140 350 1 1 {name=p43 sig_type=std_logic lab=CLKN
}
C {lab_pin.sym} 720 60 3 0 {name=p44 sig_type=std_logic lab=CLK2
}
...
C {designs/sar_adc/digital/inverter/xschem/inverter.sym} 560 140 1 0 {name=x8}
...
C {lab_pin.sym} 1540 -40 0 1 {name=p11 sig_type=std_logic lab=Q}
