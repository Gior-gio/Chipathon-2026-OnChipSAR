...
N 720 -120 720 -80 {lab=CLK2N}
N 720 20 720 60 {lab=CLK2}
N 680 -90 680 -50 {lab=VSS}
N 640 -90 640 -50 {lab=VDD}
N 330 310 330 350 {lab=CLK2}
N 370 200 370 240 {lab=VSS}
N 410 200 410 240 {lab=VDD}
N 330 170 330 210 {lab=CLK2N}
...
C {lab_pin.sym} 720 60 1 1 {name=p38 sig_type=std_logic lab=CLK2
}
C {lab_pin.sym} 330 350 3 0 {name=p39 sig_type=std_logic lab=CLK2
}
C {lab_pin.sym} 1140 350 3 0 {name=p40 sig_type=std_logic lab=CLK
}
C {lab_pin.sym} 0 -100 1 0 {name=p41 sig_type=std_logic lab=CLKN
}
C {lab_pin.sym} 330 170 3 1 {name=p42 sig_type=std_logic lab=CLK2N
}
C {lab_pin.sym} 1140 170 3 1 {name=p43 sig_type=std_logic lab=CLKN
}
C {lab_pin.sym} 720 -120 1 0 {name=p44 sig_type=std_logic lab=CLK2N
}
C {designs/sar_adc/digital/TG/xschem/TG.sym} 0 20 0 0 {name=x1}
C {designs/sar_adc/digital/TG/xschem/TG.sym} 720 0 0 0 {name=x2}
C {designs/sar_adc/digital/TG/xschem/TG.sym} 1140 290 0 1 {name=x3}
C {designs/sar_adc/digital/TG/xschem/TG.sym} 330 290 0 1 {name=x4}
C {designs/sar_adc/digital/NAND/xschem/NAND.sym} 260 -20 0 0 {name=x5}
C {designs/sar_adc/digital/NAND/xschem/NAND.sym} 1020 -40 0 0 {name=x6}
...
C {designs/sar_adc/digital/inverter/xschem/inverter.sym} 1360 -20 0 0 {name=x7}
...
C {designs/sar_adc/digital/inverter/xschem/inverter.sym} -440 490 0 0 {name=x11}
C {lab_pin.sym} -330 210 0 1 {name=p7 sig_type=std_logic lab=CLKN
}
C {lab_pin.sym} -580 470 2 1 {name=p8 sig_type=std_logic lab=CLK2
}
C {lab_pin.sym} -330 470 0 1 {name=p10 sig_type=std_logic lab=CLK2N
}
...
C {lab_pin.sym} -460 370 2 0 {name=p45 sig_type=std_logic lab=VDD}
...
C {lab_pin.sym} -460 570 0 1 {name=p48 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -580 210 2 1 {name=p49 sig_type=std_logic lab=CLK
}
C {designs/sar_adc/digital/inverter/xschem/inverter.sym} 1640 -20 0 0 {name=x12}
...
C {lab_pin.sym} 1480 -180 0 1 {name=p11 sig_type=std_logic lab=Q}
