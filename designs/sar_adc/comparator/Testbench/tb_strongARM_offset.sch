...
N 550 -320 550 -300 {lab=VDD}
N 550 -320 570 -320 {lab=VDD}
N 550 -260 550 -230 {lab=GND}
N 550 -180 550 -160 {lab=VDD}
...
C {gnd.sym} 100 0 0 0 {name=l2 lab=GND}
...
C {vsource.sym} 100 -50 0 0 {name=V4 value=\{vcm\} savecurrent=false}
...
C {code_shown.sym} 830 -300 0 0 {name=s1 only_toplevel=false value="
.param VDD = 3.3
...
.end
"}
C {Chipathon-2026-OnChipSAR/designs/sar_adc/comparator/StrongARM/strongARM.sym} 370 -210 0 0 {name=x1}
...
C {Chipathon-2026-OnChipSAR/designs/sar_adc/comparator/Inverter/inv.sym} 630 -180 0 0 {name=x2[9:0]}
C {Chipathon-2026-OnChipSAR/designs/sar_adc/comparator/Inverter/inv.sym} 630 -40 0 0 {name=x1[9:0]}
...
C {lab_pin.sym} 570 -320 0 1 {name=p8 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 570 -180 0 1 {name=p9 sig_type=std_logic lab=VDD}
