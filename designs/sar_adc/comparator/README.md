...
### Design Summary (PVT & Monte Carlo Verification)
![Design Summary — PVT & Monte Carlo Verification](design_summary.png)

### PVT Waveforms Overlay
![PVT Waveforms Overlay](pvt_waveforms_overlay.png)

### Monte Carlo Histograms
![Monte Carlo Histograms](mc_histograms.png)
