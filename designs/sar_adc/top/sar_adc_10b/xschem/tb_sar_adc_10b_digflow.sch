...
let tstep = 1/(Fs*12*200)
let tstop = (Ns + Nspare)/Fs

* Save main signals
save V(VIN) V(VX) V(VY) \\"B[9]\\" \\"B[8]\\" \\"B[7]\\" \\"B[6]\\" \\"B[5]\\" \\"B[4]\\" \\"B[3]\\" \\"B[2]\\" \\"B[1]\\" \\"B[0]\\" V(xADC.COMP) I(VSP) I(VREFP) I(VREFN) v(samp) v(clk)
*save all
...
let clk = v(clk)
let vxy = V(VX)-V(VY)
let vin2 = v(vin)*2 - (VRP + VRN)
let dout = (\\"B[9]\\"*1/2 + \\"B[8]\\"*1/4 +
+ \\"B[7]\\"*1/8 + \\"B[6]\\"*1/16 +
+ \\"B[5]\\"*1/32 + \\"B[4]\\"*1/64 +
+ \\"B[3]\\"*1/128 + \\"B[2]\\"*1/256 +
+ \\"B[1]\\"*1/512 + \\"B[0]\\"*1/1024)
let dout2 = dout*2*VRPN/vdd - vrpn
...
* export waveforms
wrdata tb_sar_adc_10b_digflow.csv v(VIN) v(VX) v(VY) dout P_REF P_VDD
