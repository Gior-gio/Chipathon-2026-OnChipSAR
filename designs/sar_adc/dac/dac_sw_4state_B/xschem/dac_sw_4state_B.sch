...
F {}
E {}
P 4 5 2020 -760 2580 -760 2580 -40 2020 -40 2020 -760 {}
P 4 5 1940 -640 60 -640 60 -80 1940 -80 1940 -640 {}
P 4 1 -40 -460 {}
P 4 1 660 -690 {}
T {TO BOTTOM PLATE
DAC VOLTAGES} 2390 -740 0 0 0.3 0.3 {}
T {CONTROL SIGNALS
FROM SAR LOGIC} 80 -380 0 0 0.3 0.3 {}
N 2460 -410 2520 -410 {lab=CI}
N 2120 -620 2180 -620 {lab=VBP}
N 2260 -730 2260 -670 {lab=VDD}
N 2400 -560 2460 -560 {lab=CI}
N 2400 -260 2460 -260 {lab=CI}
N 2120 -600 2180 -600 {lab=BP}
N 2120 -640 2180 -640 {lab=BPN}
N 2260 -430 2260 -370 {lab=VDD}
N 2340 -480 2400 -480 {lab=CI}
N 2260 -570 2260 -530 {lab=VSS}
N 2340 -620 2400 -620 {lab=CI}
N 2400 -620 2400 -480 {lab=CI}
N 2260 -130 2260 -70 {lab=VDD}
N 2340 -180 2400 -180 {lab=CI}
N 2260 -270 2260 -230 {lab=VSS}
N 2340 -320 2400 -320 {lab=CI}
N 2400 -320 2400 -180 {lab=CI}
N 2460 -560 2460 -260 {lab=CI}
N 2120 -480 2180 -480 {lab=VBN}
N 2120 -460 2180 -460 {lab=BNN}
N 2120 -500 2180 -500 {lab=BN}
N 2120 -320 2180 -320 {lab=VRST}
N 2120 -300 2180 -300 {lab=RST}
N 2120 -340 2180 -340 {lab=RSTN}
N 2120 -180 2180 -180 {lab=VSAM}
N 2120 -160 2180 -160 {lab=SAMN}
N 2120 -200 2180 -200 {lab=SAM}
...
C {ipin.sym} 2120 -320 0 0 {name=p11 lab=VRST}
C {iopin.sym} 2520 -410 2 1 {name=p1 lab=CI}
C {ipin.sym} 2120 -180 0 0 {name=p16 lab=VSAM}
C {ipin.sym} 2120 -620 0 0 {name=p26 lab=VBP}
C {ipin.sym} 2120 -480 0 0 {name=p31 lab=VBN}
C {designs/sar_adc/dac/dac_sw_1state_B/xschem/dac_sw_1state_B.sym} 2260 -620 0 0 {name=xBP}
C {lab_wire.sym} 2260 -720 3 0 {name=p46 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 2260 -540 3 1 {name=p47 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 2130 -600 0 1 {name=p44 sig_type=std_logic lab=BP}
C {lab_wire.sym} 2130 -640 0 1 {name=p45 sig_type=std_logic lab=BPN}
C {designs/sar_adc/dac/dac_sw_1state_B/xschem/dac_sw_1state_B.sym} 2260 -480 2 1 {name=xBN}
C {lab_wire.sym} 2260 -380 3 1 {name=p50 sig_type=std_logic lab=VDD}
C {designs/sar_adc/dac/dac_sw_1state_B/xschem/dac_sw_1state_B.sym} 2260 -320 0 0 {name=xRST}
C {lab_wire.sym} 2260 -240 3 1 {name=p52 sig_type=std_logic lab=VSS}
C {designs/sar_adc/dac/dac_sw_1state_B/xschem/dac_sw_1state_B.sym} 2260 -180 2 1 {name=xSAM}
C {lab_wire.sym} 2260 -80 3 1 {name=p55 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 2130 -460 0 1 {name=p48 sig_type=std_logic lab=BNN}
C {lab_wire.sym} 2130 -500 0 1 {name=p49 sig_type=std_logic lab=BN}
C {lab_wire.sym} 2130 -300 0 1 {name=p51 sig_type=std_logic lab=RST}
C {lab_wire.sym} 2130 -340 0 1 {name=p53 sig_type=std_logic lab=RSTN}
C {lab_wire.sym} 2130 -160 0 1 {name=p54 sig_type=std_logic lab=SAMN}
C {lab_wire.sym} 2130 -200 0 1 {name=p56 sig_type=std_logic lab=SAM}
